                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-12 col-sm-12 col-md-12">
                            <div className={`${styles['pagination-area']} text-center`}>
                                <a href="#" className={`prev ${styles['page-numbers']}`}>
                                    <i className='bx bx-chevrons-left'></i>
                                </a>
                                <span className={`${styles['page-numbers']} current`} aria-current="page">1</span>
                                <a href="#" className={styles['page-numbers']}>2</a>
                                <a href="#" className={styles['page-numbers']}>3</a>
                                <a href="#" className={styles['page-numbers']}>4</a>
                                <a href="#" className={`next ${styles['page-numbers']}`}>
