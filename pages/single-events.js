...
import styles from '../components/SingleEvents/Events.module.css';
    ...
    return (
        <>
            ...
            <div className="events-details-area pb-100">
                <div className={styles['events-details-image']}>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-8 col-md-12">
                            <div className={styles['events-details-header']}>
                                <ul>
                            ...
                            <div className={styles['events-details-location']}>
                                <div id="map">
                            ...
                            <div className={styles['events-details-desc']}>
